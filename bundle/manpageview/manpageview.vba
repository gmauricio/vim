...
"   DechoWF "(ManPageView) a:0=".a:0." topic<".topic.">"
   if a:1 =~ "("
	" abc(3)
"	DechoWF "has parenthesis: a:1<".a:1.">  ft<".&ft.">"
	let a1 = substitute(a:1,'[-+*/;,.:]\+$','','e')
"	DechoWF "has parenthesis: a:1<".a:1.">  a1<".a1.">"
	if &ft == 'sh'
"	 DechoWF 'has parenthesis: but ft<'.&ft."> isn't <man>"
...
"	 DechoWF 'has parenthesis: but ft<'.&ft."> isn't <man>"
    ...
    elseif a1 =~ '[,"]'
"	 DechoWF 'has parenthesis: a:1 matches [,"]'
     let manpagetopic= substitute(a1,'[(,"].*$','','e')
	else
"	 DechoWF 'has parenthesis: a:1 does not match [,"]'
...
475
*manpageview.txt*	Man Page Viewer			Jun 18, 2012

Author:  Charles E. Campbell, Jr.  <NdrchipO@ScampbellPfamily.AbizM>
	  (remove NOSPAM from Campbell's email first)
Copyright: (c) 2004-2012 by Charles E. Campbell, Jr.	*manpageview-copyright*
